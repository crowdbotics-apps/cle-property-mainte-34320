...
## Project Structure
    ...
    ├── cle_property_mainte_34320  # Django project configurations
...
1. Clone this repo and `cd cle_property_mainte_34320`
...
2. Clone this repo and `cd cle_property_mainte_34320`
